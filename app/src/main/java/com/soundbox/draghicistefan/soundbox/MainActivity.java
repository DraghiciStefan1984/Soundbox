    ...
    public void fetchSongsFromWeb()
    {
        ...
        Thread thread = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    URL url = new URL("http://217.199.187.193/musicservertest.com/music_app/getmusic.php");
            ...
            public void run()
            {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
                {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id)
                    {
                        ...
                        String songAddress = "http://217.199.187.193/musicservertest.com/music_app/" + song.getTitle();
    ...
    public void markSongPlayed(final int id)
    {
        Thread thread = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    URL url = new URL("http://217.199.187.193/musicservertest.com/music_app/add_play.php?id=" + Integer.toString(id));
                    urlConnection = (HttpURLConnection) url.openConnection();
                    urlConnection.setRequestMethod("GET");
    ...
    public void likeSong(final int id)
    {
        Thread thread = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    URL url = new URL("http://217.199.187.193/musicservertest.com/music_app/add_like.php?id=" + Integer.toString(id));
                    urlConnection = (HttpURLConnection) url.openConnection();
                    urlConnection.setRequestMethod("GET");
